...
public class ExportCrowdinMojo extends AbstractCrowdinMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		String uri = "https://api.crowdin.com/api/project/" + authenticationInfo.getUserName() + "/export?key="
				+ authenticationInfo.getPassword();

		getLog().info(
				"Calling " + "https://api.crowdin.com/api/project/" + authenticationInfo.getUserName() + "/export?key="
						+ "?????");
